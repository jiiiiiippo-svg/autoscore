...
export default function Home() {
  return (
    <main style={{ margin: 0, padding: 0, background: "white" }}>
      ...
      <header style={{ background: "white", padding: "22px 24px 12px", display: "flex", flexDirection: "column", alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 5 }}>
          <svg width="40" height="40" viewBox="0 0 100 100" fill="none">
            <path d="M15 72 A38 38 0 1 1 85 72" stroke="#e2e8f0" strokeWidth="8" strokeLinecap="round" fill="none" />
            <path d="M15 72 A38 38 0 0 1 50 14" stroke={GREEN} strokeWidth="8" strokeLinecap="round" fill="none" />
            <line x1="50" y1="50" x2="25" y2="29" stroke={DARK} strokeWidth="4.5" strokeLinecap="round" />
      ...
      {/* ── Hero ── */}
      <section style={{
        background: "linear-gradient(160deg, #f0faf4 0%, #f8fafc 45%, #eef6fb 100%)",
